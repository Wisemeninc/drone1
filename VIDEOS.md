...
Curated videos covering every phase of your first 5" quad build. Organized by skill progression — work through top to bottom.

> **Channels to subscribe to:** Joshua Bardwell, Mr Steele, Le Drib, Rotor Riot, BotGrinder, Painless360, Mads Tech, Chris Rosser, Oscar Liang
...
**Start with #1 (Bardwell) — it's comprehensive.** Then watch #2 right before you solder your FC.
...
| 3 | [DJI N3 FPV Goggle Setup: Unboxing to binding](https://www.youtube.com/watch?v=1xluwfcn9B0) | Painless360 | Complete DJI goggles activation, firmware updates, binding, DVR settings |
...
| 3 | [How To FPV — The KEY to becoming a BETTER PILOT (Part 3)](https://www.youtube.com/watch?v=wcCk9VMq2AY) | Mr Steele | Advanced progression — improving stick control and developing flow |
...
| 4 | [I decided that I don't hate FPV now.](https://www.youtube.com/watch?v=T3eDJ54y5AQ) | BotGrinder | Raw, gritty urban freestyle — the pure fun of ripping with friends |
...
- **Pawel Spychalski** — iNav lead developer, deep technical content (search: "Pawel Spychalski iNav")
...
| 3 | [Ardupilot flight modes explained simply](https://www.youtube.com/watch?v=BzSjAGQy1kM) | Painless360 | All ArduPilot flight modes — shows what ArduPilot can do that simpler FCs cannot |
...
Week 5:     FPV system setup (Section 5)
Week 5-6:   First real flights (Section 7)
Ongoing:    Watch inspiration (Section 8) whenever you need motivation
Later:      When ready for GPS autonomy → iNav (Section 9) or Ardupilot (Section 10)
```
...
- **Mr Steele's 3-part "How To FPV" series** is the best intro to the hobby if you watch nothing else.
- **Painless360** is the go-to for iNav and Ardupilot — his beginner series are updated yearly.
- **Chris Rosser** covers both FPV builds and Ardupilot tuning at a high level.
...
- All URLs verified as of May 2026. If a link dies, search the exact title on YouTube.
