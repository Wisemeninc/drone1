# Shopping List — AliExpress, Quad Only (3 Budget Tiers)

Just the **flying quad** components, all with direct AliExpress search links. Pick a tier and click through each row.

> **What's NOT on this page:** batteries, soldering kits, support equipment (chargers, power supplies, LiPo bags), and remotes/radios/goggles. For those, see [SHOPPING-LIST.md](./SHOPPING-LIST.md) — those items should be bought from EU stock (Amazon.de, n-Factory.de, FlyingMachines.de) because:
>
> - **Batteries** (LiPos) cannot air-ship from China — always buy from EU stock
...
| 11 | Buzzer (5V, with wire) | 1 | $3 | [AliExpress](https://www.aliexpress.com/w/wholesale-FPV-buzzer-5V-drone.html) |
| 12 | XT60 pigtail (male, 12AWG, 10cm) | 2 | $5 | [AliExpress](https://www.aliexpress.com/w/wholesale-XT60-pigtail-12AWG-10cm.html) |
...
> **Note (September 2026):** the Mamba F50 Pro is still stocked on AliExpress, which is why it stays in this AliExpress-only list — but no EU FPV shop checked still carries it. The rest of the guide substitutes the T-Motor F55A Pro II (55A, BL32 preloaded). See [SHOPPING-LINKS-EU.md](./SHOPPING-LINKS-EU.md).
...
| 10 | Low ESR capacitor (35V 1000uF) | 2 | $4 | [AliExpress](https://www.aliexpress.com/w/wholesale-low-ESR-capacitor-35V-1000uF.html) |
...
| # | Item | Qty | Est. Price | AliExpress |
|---|------|-----|-----------|------------|
| 1 | ImpulseRC Apex 5" HD frame | 1 | $90 | [AliExpress](https://www.aliexpress.com/w/wholesale-ImpulseRC-Apex-5-inch-HD-frame.html) |
| 2 | Diatone Mamba F722 MK4 Flight Controller | 1 | $55 | [AliExpress](https://www.aliexpress.com/w/wholesale-Diatone-Mamba-F722-MK4.html) |
| 3 | T-Motor F55A Pro II 4-in-1 ESC (BL32) | 1 | $65 | [AliExpress](https://www.aliexpress.com/w/wholesale-T-Motor-F55A-Pro-II-ESC.html) |
| 4 | T-Motor Velox V2 2306 1900KV motors | 4 | $80 | [AliExpress](https://www.aliexpress.com/w/wholesale-T-Motor-Velox-V2-2306-1900KV.html) |
| 5 | HQProp 5x4.3x3 V2S (5 pack) | 3 packs | $25 | [AliExpress](https://www.aliexpress.com/w/wholesale-HQProp-5x4.3x3-V2S.html) |
| 6 | Ethix S5 props (5 pack) | 2 packs | $20 | [AliExpress](https://www.aliexpress.com/w/wholesale-Ethix-S5-propeller.html) |
| 7 | DJI O4 Air Unit (VTX + camera + 4K recording) | 1 | $130 | [AliExpress](https://www.aliexpress.com/w/wholesale-DJI-O4-Air-Unit.html) |
| 8 | RadioMaster RP3 ELRS 2.4GHz receiver (diversity) | 1 | $20 | [AliExpress](https://www.aliexpress.com/w/wholesale-RadioMaster-RP3-ELRS-diversity.html) |
| 9 | TBS Triumph Pro antenna (RHCP) | 1 | $18 | [AliExpress](https://www.aliexpress.com/w/wholesale-TBS-Triumph-Pro-antenna-RHCP.html) |
| 10 | Low ESR capacitor (35V 1000uF) | 2 | $4 | [AliExpress](https://www.aliexpress.com/w/wholesale-low-ESR-capacitor-35V-1000uF.html) |
| 11 | BN-220 GPS module | 1 | $14 | [AliExpress](https://www.aliexpress.com/w/wholesale-BN-220-GPS-module.html) |
...
- All links are **AliExpress search-by-keyword** URLs. They always return current top sellers for the requested part — no dead listings.
- Click a row → review the top 3–5 results → pick one with high orders + good ratings (4.7+) + recent reviews.
- For multi-vendor sourcing of these same parts (n-Factory.de, Rotorama, BangGood, etc.), see [SHOPPING-LIST.md](./SHOPPING-LIST.md).
- Component descriptions, alternatives, and selection guidance are in [COMPONENTS.md](./COMPONENTS.md).
